...
`v0.2.2` runtime source asset 이름은 다음과 같습니다.
...
별도로 검증한 standalone installer도 사용할 수 있습니다. 옆에 완전한 source tree가 없으면 `ICA_ROUTER_REF`의 정확한 asset을 받습니다. 기본값은 `v0.2.2`입니다.
